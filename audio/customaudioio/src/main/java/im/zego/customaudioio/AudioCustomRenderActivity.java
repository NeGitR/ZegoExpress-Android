...
public class AudioCustomRenderActivity extends AppCompatActivity {
    ...
    private String roomId="NeTest-1";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(BEDEBUG) {
            recordingFile = new File(parent, "self-render-audioRecord.pcm");
    ...
    private void initView() {
        ...
        startRender.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                engine.startPlayingStream(editText.getText().toString().trim());
                startRender();
            }
        });
...
//        byte[] bytes = new byte[mRenderBufferSize];
        ...
        while (mStatus== Status.STATUS_START){
             ...
             if(BEDEBUG) {
                try {
                    dos.write(bytes, 0, mRenderBufferSize);
                } catch (IOException e){
                    e.printStackTrace();
