...
public class CapturedAudioActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.captured_audio);
        checkPermissions();
        initView();
        ...
        String fileName =  "onCapturedAudioData-" + Integer.toString(audioFrameParam.sampleRate.value())
    ...
    private void initView() {
        loginRoom = findViewById(R.id.login_room2);
        stop = findViewById(R.id.logoutRoom);

        publishState =findViewById(R.id.publish_state2);
        publishStreamIdEditText=findViewById(R.id.capture_stream_id2);
